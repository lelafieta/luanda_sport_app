...
class GetCallUpsByPlayerPendingUseCase
    extends BaseUseCases<List<CallUpEntity>, String> {
  final ICallUpRepository callUpRepository;
  GetCallUpsByPlayerPendingUseCase({required this.callUpRepository});

  @override
  Future<Either<Failure, List<CallUpEntity>>> call(String params) {
    return callUpRepository.getCallUpsByPlayerPending(params);
  }
}
