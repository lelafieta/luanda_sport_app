...
class CreateTrophyUseCase extends BaseUseCases<Unit, TrophyEntity> {
  final ITrophyRepository trophyRepository;

  CreateTrophyUseCase({required this.trophyRepository});

  @override
  Future<Either<Failure, Unit>> call(TrophyEntity params) {
    return trophyRepository.createTrophy(params);
  }
}
